    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLayouts01" aria-expanded="false" aria-controls="collapseLayouts"
                    ><div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                    Manage Customer
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div
                ></a>
                <div class="collapse {{ ($prefix == '/customer')?'show':'' }}" id="collapseLayouts01" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link {{ ($route == 'customer.view')?'active':'' }}" href="{{ route('customer.view') }}">View Customer</a>

                        <a class="nav-link {{ ($route == 'customer.draf')?'active':'' }}" href="{{ route('customer.draf') }}">Draf Customer</a>
                </div>
                {{-- manage customer end --}}
