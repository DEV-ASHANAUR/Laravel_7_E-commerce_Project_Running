                ...
                <div class="card-body">
                    <div class="row">
                      <div class="col-md-8 m-auto">
                        @include('inc.error')
                      <form action="{{ route('product.update',$editdata->id) }}" method="post" id="Myform" enctype="multipart/form-data">
                          @csrf
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-4" id="test">
                              <img src="{{ url('upload/product_image/'.$editdata->image) }}" class="img-fluid img-thumbnail" width="150px" height="150px" alt="">
                            </div>
                          </div>
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                              @foreach ($sub_image as $sub_image)
                                  <img src="{{ url('upload/product_sub_image/'.$sub_image->sub_image) }}" class="img-fluid img-thumbnail" width="80px" height="80px" alt="">
                              @endforeach
                            </div> 
                          </div>
                          <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="number" value="{{ $editdata->price }}" class="form-control" id="main_price" name="price">
                            </div>
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="title">Product Discount</label> <small>(<span class="text-danger">Ex:40; In percent</span>)</small>
                                <input type="number" value="{{ $editdata->discount }}" id="discount" class="form-control" name="discount">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select name="category" class="form-control" id="category">
                                ...
                                @foreach ($category as $key => $cat)
                                 <option value="{{ $cat->id }}" {{ ($cat->id==$editdata->cat_id)?'selected':'' }}>{{ $cat->name }}</option>
                                @endforeach
                              </select>
                            </div>
                            <div class="form-group col-md-6">
                              ...
                              <select name="brand" class="form-control" id="brand">
                                ...
                                @foreach ($brand as $key => $brand)
                                 <option value="{{ $brand->id }}" {{ ($brand->id==$editdata->brand_id)?'selected':'' }}>{{ $brand->name }}</option>
                                @endforeach
                              </select>
                            </div>
                          </div>
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select name="manufacture" class="form-control" id="manufacture">
                                ...
                                @foreach ($manufacture as $key => $manufacture)
                                 <option value="{{ $manufacture->id }}" {{ ($manufacture->id==$editdata->manufacture_id)?'selected':'' }}>{{ $manufacture->name }}</option>
                                @endforeach
                              </select>
                            </div>
                            <div class="form-group col-md-6">
                              <label for="title">Product Stock <small>(<span class="text-danger">In Number</span>)</small></label>
                              <input type="text" value="{{ $editdata->stock }}" class="form-control" name="stock">
                            </div>
                          </div>       
                          <div class="form-row"> 
                              <div class="form-group col-md-12">
                                  <label for="description">Description</label>
                                  <textarea class="form-control" name="description" placeholder="Enter Some Description" id="description">{{ $editdata->long_desc }}</textarea>
                              </div>
                          </div>
